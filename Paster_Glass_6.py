...
def valves():
    ...
    top.resizable(0,0)
    frame = Frame(top, width="1350",height="500")
    frame.pack()
    swin = ScrolledWindow(frame, width=1350, height=500)
    swin.pack()
    win = swin.window
    canvas1 = Canvas(win, width=1350, height=16000) 
    canvas1.pack(side=LEFT, fill=BOTH, expand=True)
    Label(top, text = "                    V01        V02        V03        V04        V05        V06        V07        V08        V09        V10        V11        V12        V13        V14        V15        V16        V17        V18        V19        V20        V21        V22        V23        V24        V25        V60        V61        V62        V70").place(x = 10, y=10)
    ...
    with sqlite3.connect("database.db") as db:
        ...
        query_valves = """SELECT time, V01, V02, V03, V04, V05, V06,
                ...
                V18, V19, V20, V21, V22, V23, V24, V25, V60, V61, V62, V70
                FROM Valves_Glass_6
                WHERE (date = '%(day)s')
                """ %{'day' : day}
...
def mnemo():
    img1 = Image.open('Glass_6_mnemo_buffer.png')
    img1.show()
    img2 = Image.open('Glass_6_mnemo_paster.png')
    img2.show()
    
root = Tk()
root.title('Paster Glass_6')
